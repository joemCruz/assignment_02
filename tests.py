...
class TestAssignmentTwo_None(unittest.TestCase):
    ...
    def test_none_is_universal(self):
        ...
        """
        #[Joseph] added None to assert that None is None
        truth = True
    ...
    def test_none_existence(self):
        ...
        if checker:
            x = 1
        #[Joseph] Changed 1 to 0 in assertEqual
...
class TestAssignmentTwo_Strings(unittest.TestCase):
    ...
    def test_translation(self):
        ...
        leet = str.maketrans('abegiloprstzT', '4636110925727')
        s = 'The quick brown fox jumped over the lazy dog.'
        translated = s.translate(leet)

        truth = '7h3 qu1ck 620wn f0x jum93d 0v32 7h3 142y d06.'

        self.assertEqual(truth, translated)
    ...
    def test_write_your_own(self):
        ...
        self.assertEqual(strlen, len(string))
